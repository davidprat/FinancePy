...
def test_FinIborCapFloorVolCurve():
    ...
    frequency = frequency_types.ANNUAL
...
#    print(volCurve._capletGammas)
    ...
    tcap = (maturity_date - valuation_date) / g_days_in_year
